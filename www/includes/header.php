    ...
    <nav class="sidebar">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <?php elseif ($rol == 'auxiliar'): ?>
                <li class="nav-item"><a href="/auxiliar/dashboard.php" class="nav-link"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
            ...
            <?php elseif ($rol == 'estudiante'): ?>
                <li class="nav-item"><a href="/estudiante/dashboard.php" class="nav-link"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
            ...
            <?php elseif ($rol == 'apoderado'): ?>
                <li class="nav-item"><a href="/apoderado/dashboard.php" class="nav-link"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
